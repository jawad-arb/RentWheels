...
public class CarQuery {
    ...
    public static final String GET_ALL_AVAILABLE_CARS = "SELECT * FROM Cars WHERE maintenance_status='Good'";
    public static final String GET_COST_BY_CAR_ID = "SELECT price From Cars WHERE car_id=?";
